                                ...
                                @forelse ($labels as $label)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            <a href="{{ route('labels.show', $label) }}" class="text-indigo-600 hover:text-indigo-900">
                                                View
                                            </a>
                                            <a href="{{ route('labels.edit', $label) }}" class="text-green-600 hover:text-green-900">
                                                Edit
                                            </a>
                                            <form class="inline" method="POST" action="{{ route('labels.destroy', $label) }}"
